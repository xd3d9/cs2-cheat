...
inline std::string client = "client.dll";
inline const char* clientdll = client.c_str();
#define SCHEMA(type, name, binding_name, field_name) SCHEMA_EXTENDED(type, name, clientdll, binding_name, field_name, 0)
...
#define PSCHEMA(type, name, binding_name, field_name) PSCHEMA_EXTENDED(type, name, clientdll, binding_name, field_name, 0)